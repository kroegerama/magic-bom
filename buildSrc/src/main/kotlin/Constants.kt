object C {
    ...
    const val USER_ID = "kroegerama"
    const val USER_NAME = "Chris"
    const val USER_MAIL = "1519044+kroegerama@users.noreply.github.com"

    const val PROJECT_NAME = "Magic BOM"
    const val PROJECT_DESCRIPTION = "Dependency versions for modern android applications"

    const val PROJECT_VERSION = "1.1.11"
    ...
    val PROJECT_TAGS = arrayOf("kaiteki", "magic", "pom")
